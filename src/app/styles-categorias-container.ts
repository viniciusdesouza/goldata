// NOVO: Estilos exclusivos para área de grid/lista de categorias (clubes, campeonatos, jogadores)

// Container principal centralizado da página de categorias
// Aumentado para max-w-4xl para padrão mais largo e visual moderno
export const CATEGORIA_CONTAINER =
  "w-full max-w-4xl mx-auto px-4 sm:px-8 flex flex-col items-center";

// Grid: 2 colunas, 10 linhas no desktop, 1 coluna no mobile, espaço reduzido
export const CATEGORIA_GRID =
  "grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3 w-full mt-3";

// Card individual reduzido, 100% da coluna, altura baixa
