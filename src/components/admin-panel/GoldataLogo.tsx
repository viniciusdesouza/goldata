...
interface GoldataLogoProps {
  className?: string;
  color?: "black" | "white";
}

/**
 * Logotipo SVG da GolData.
 * Usa cor do tema se não especificado.
 */
export function GoldataLogo({
  className = "w-7 h-7",
  color,
}: GoldataLogoProps) {
  const fillColor =
