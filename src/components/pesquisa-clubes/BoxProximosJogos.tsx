...
interface BoxProximosJogosProps {
  jogos: any[];
  titulo?: string;
  pageSize?: number;
}

const BoxProximosJogos: React.FC<BoxProximosJogosProps> = ({
  jogos = [],
  titulo,
  pageSize = 5,
}) => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-[6px] border border-gray-200 dark:border-zinc-700 p-4">
      <div className="font-semibold mb-2">{titulo || "Próximos Jogos"}</div>
...
export default BoxProximosJogos;